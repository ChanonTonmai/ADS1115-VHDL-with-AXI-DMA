...
#define MAX_PKT_LEN		BUFFER_SIZE_DWORDS*4
...
//XGpio adc_config_gpio; /* The Instance of the GPIO Driver */
...
int main(void)
{
	int Status;
	int userInput;
	Xil_Out32(0x43C00000,0x000001C8);
	init_platform();
	xil_printf("Hello select\n\r");
...
//	} else {
//		userInput = 1;
//	}https://www.youtube.com/watch?v=m7VNS7wIybw
...
//	Xil_Out32(0x43C00000,0x00000007);
	while(1) {

		Xil_Out32(0x43C00000,0x000001CF);
		for(int i=0; i < 100000; i++) {
			//delay
		}
//		Xil_Out32(0x43C00000,0x00000004);
		Xil_DCacheFlushRange((UINTPTR)RxBufferPtr, MAX_PKT_LEN);
